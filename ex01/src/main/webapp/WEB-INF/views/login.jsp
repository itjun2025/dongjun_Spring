...
body {
	...
	padding-top: 40px;
	padding-bottom: 40px;
	background-color: rgb(186, 213, 235)
}
...
<script>
      ...
      window.addEventListener('load',function(){
        ...
        pwCheck.addEventListener('blur', function(){
			...
			if(!pwCheck.value){
				signupMsg.innerHTML = '비밀번호 확인해주세요';
			}
...
<body class="text-center">
	...
	<form name='signinForm'>
		<img class="mb-4" src="/resources/css/brand/햄버거.png" alt="" width="72"
			height="57">
		<h1 class="h3 mb-3 fw-normal">Please sign in</h1>
		<div id="msg">${param.msg }</div>

		<div class="form-floating">
			<input type="text" class="form-control start" required="required"
				id="id" placeholder="id"> <label for="id">id</label>
		</div>
		<div class="form-floating">
			<input type="password" class="form-control end" required="required"
				id="pw" placeholder="Password"> <label for="pw">Password</label>
		</div>
	...
	<form name='signupForm' style='display: none'>
		...
		<div class="form-floating">
			<input type="text" class="form-control start" id="signUpId"
				placeholder="id"> <label for="signUpId">Id</label>
		</div>
		
		<div class="form-floating">
			<input type="text" class="form-control middle" id="signUpName"
				placeholder="name"> <label for="signUpName">Name</label>
		</div>
		
		<div class="form-floating">
			<input type="password" class="form-control middle" id="signUpPw"
				placeholder="Password"> <label for="signUpPw">Password</label>
		</div>
		<div class="form-floating">
			<input type="password" class="form-control end" id="pwCheck"
				placeholder="PasswordCheck"> <label for="pwCheck">PasswordCheck</label>
		</div>

		<button class="w-100 btn btn-lg btn-primary" id='btnSignup'
			type="submit">회원가입</button>
		<p class="mt-5 mb-3 text-muted">&copy; 2017–2022</p>


		<input type="text" value="0" id="idCheckRes"> <input
			type="text" value="0" id="pwCheckRes">
    ...
    // 요청URL -> 네이버로그인및 사용자 정보제공 동의 -> 콜백으로 코드를 제공
